...
export interface IAirportsSelectInputData {
	label: string;
	region: string;
	value: string;
}

export let countriesSelectInputData: ICountriesData[] = [];

countries_data.map((country) =>
	countriesSelectInputData.push({
		label: country?.name,
		alphaCode1: country?.alpha2Code,
		alphaCode2: country?.alpha3Code,
		value: country?.name,
	})
);

// export function getAirportsSelectInputData(airports: IAirport[]) {
//   let airportsSelectInputData: IAirportsSelectInputData[] = [];
//   airports?.map((airport: IAirport) =>
//     airportsSelectInputData.push({
//       label: airport?.name,
...
//   return airportsSelectInputData;
// }
